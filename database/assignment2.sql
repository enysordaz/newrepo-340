...
UPDATE public.inventory
SET 
  inv_image = REPLACE(inv_image, 'ima', 'images/vehicles'),
  inv_thumbnail = REPLACE(inv_thumbnail, 'ima', 'images/vehicles');
...
-- CSE 340 -- DB creation and also is in the folder as a separate file
